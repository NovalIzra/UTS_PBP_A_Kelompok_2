...
public class FligthTicketActivity extends AppCompatActivity {
    private DatePickerDialog datePickerDialog;
    private SimpleDateFormat dateFormatter;
    private AppDatabase database;
    String CHANNEL_ID="10001";

    ActivityFligthTicketBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = DataBindingUtil.setContentView(this,R.layout.activity_fligth_ticket);
        ...
        binding.btnorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String flightclass = binding.edtflightclass.getText().toString().trim();
                ...
                if (from.isEmpty() && to.isEmpty() && waktu.isEmpty() && passenger.isEmpty() && flightclass.isEmpty()){
                    ...
                    database.orderTicketDao().insertorder(from,to,waktu,Integer.parseInt(passenger),flightclass, SessionManager.getIsUsername(getBaseContext()),"flight");
                    notifikasi("tiket penerbangan berhasil di order", "travelskuy");
