...
import com.travel.travelskuy.databinding.ActivityTrainTicketBinding;
...
public class TrainTicketActivity extends AppCompatActivity {
    ...
    ActivityTrainTicketBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_train_ticket);
        ...
        binding.btnorder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String flightclass = binding.edtpassengerclass.getText().toString().trim();

                if (from.isEmpty() && to.isEmpty() && waktu.isEmpty() && passenger.isEmpty() && flightclass.isEmpty()) {
                    Snackbar.make(v, "isi semua kolom ", Snackbar.LENGTH_LONG).show();
                } else {
                    database.orderTicketDao().insertorder(from, to, waktu, Integer.parseInt(passenger), flightclass, SessionManager.getIsUsername(getBaseContext()), "train");
                    notifikasi("tiket Kereta berhasil di order", "travelskuy");
